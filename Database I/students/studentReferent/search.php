            ...
            <div class="form-wrapper">
                ...
                <form action="landing.php" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-input" name="referent_id" id="referent_id">
                            <option value="" disabled selected hidden>Referent's ID</option>
                            <?php
                                $query = "SELECT referent_id FROM referent";
                                $referentsList = $conn->query($query);

                                while($referent = $referentsList->fetch_assoc()){
                                    echo "<option value='". $referent['referent_id'] ."'>". $referent['referent_id'] ."</option>";
                                }
                    ...
                    <div class="input-flex">
                        ...
                        <div>
                            ...
                            <input type="text" name="referent_surname" id="referent_surname" placeholder="Referent's surname" class="form-input" readonly/>
                        </div>
