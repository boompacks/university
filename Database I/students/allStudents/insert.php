    ...
    <body>
        <div class="content">
            ...
            <div class="form-wrapper">
                <p class="parameters">Insert the data of the new student</p><hr>
                <form action="inserted.php" method="POST">
                    <div class="input-flex">
                        <div>
                            <label for="name" class="form-label"> First Name </label>
                            <input type="text" name="name" id="name" placeholder="Student's name" class="form-input" pattern="[a-zA-Z]*" required/>
                        </div>

                        <div>
                            <label for="surname" class="form-label"> Last Name </label>
                            <input type="text" name="surname" id="surname" placeholder="Student's last name" class="form-input" pattern="[a-zA-Z]*" required/>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-input" name="country" id="country" required>
                            <option value="Italy" selected hidden>Italy</option>
                            <?php
