    ...
    <body>
        <div class="content">
            ...
            <div class="form-wrapper">
                <p class="parameters">Insert some parameters to make a specific search</p>
                <form action="landing.php" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-input" name="area" id="area">
                            ...
                            <?php
                                $query = "SELECT DISTINCT area FROM accomodation";
                                $areasList = $conn->query($query);

                                while($area = $areasList->fetch_assoc()){
